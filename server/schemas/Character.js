...
const CharacterSchema = mongoose.Schema({
  ...
  chBio: {
    ...
    description: {
      type: String,
      default: null,
      maxLength: [2000, 'Character description cannot be longer than 2000 characters'],
    },
    height: {
      type: Number,
      default: null,
...
/*
      ...
      class: {
        ...
        keyScore: String(max 3),
        wepProf: String,
        armorProf: String,
        skillList: String,
        skillPointBonus: Number(1-10),
        skillPointScore: String(max 3),
        spellSlots: {
          -FOR EACH SLOT-
          level: Number(>=0, <=5)
        },
